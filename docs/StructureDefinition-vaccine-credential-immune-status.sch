...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/vaccinecredential/StructureDefinition/vaccine-credential-target-disease']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/us/vaccinecredential/StructureDefinition/vaccine-credential-target-disease': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/vaccinecredential/StructureDefinition/vaccine-credential-target-disease']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/vaccinecredential/StructureDefinition/vaccine-credential-target-disease': maximum cardinality of 'extension' is 1</sch:assert>
